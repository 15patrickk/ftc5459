...

{
...

    {
        ...
        telemetry.addData
            ( "01"
            , "Left Drive F: "
                + drive_power (drive_left_front)
                + ", "
                + encoder_count (drive_left_front)
            );
        telemetry.addData
            ( "02"
            , "Right Drive F: "
                + drive_power (drive_right_front)
                + ", "
                + encoder_count (drive_right_front)
            );
        telemetry.addData
            ( "03"
            , "Left Drive B: "
                + drive_power (drive_left_back)
                + ", "
                + encoder_count (drive_left_back)
            );
        telemetry.addData
            ( "04"
            , "Right Drive B: "
                + drive_power (drive_right_back)
                + ", "
                + encoder_count (drive_right_back)
            );
    } // update_telemetry
